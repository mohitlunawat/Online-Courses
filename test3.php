...
<body onload="setCountDown();">
 ...
 <?php
        ...
        else
        {
            ...
            echo "<h1 style='margin-left:450px;'><i>JAVASCRIPT TEST</i></h1>";
            echo "<form name='myform' method='POST' action='test3.php'>";
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") 
            {
              ...
              else
              {
                for($i=1;$i<$j;$i++)
                {
                  ...
                  {
                    $s=$j-1;
                  $sql5="UPDATE course SET test3='$count',status=3 WHERE studentid='$id'";
