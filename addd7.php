...
{
	$sql="SELECT count FROM subcount2 where in1='7'";
	...
	if($result2)
	{
		...
		$sql3="UPDATE subcount2 set count='$cns' where in1='7'";
		$result3=mysqli_query($conn,$sql3);
		echo "<script type='text/javascript'>alert('successfully added');";
	 	echo "window.location='jevent.php'";
     	echo "</script>";
     	$sql4="SELECT count1 from count3 where id1='7'";
		...
		if($result4)
		{
      	...
      	$cj=$cj+1;
      	$sql5="UPDATE count3 set count1='$cj' where id1='7'";
...
<body>
<form method="POST" action="addd7.php">
