...
{
	$sql="SELECT count FROM subcount1 where in1='1'";
	...
	if($result2)
	{
		...
		$sql3="UPDATE subcount1 set count='$cns' where in1='1'";
		$result3=mysqli_query($conn,$sql3);
		echo "<script type='text/javascript'>alert('successfully added');";
	 	echo "window.location='cintro.php'";
     	echo "</script>";
     	$sql4="SELECT count1 from count2 where id1='1'";
		...
		if($result4)
		{
      	...
      	$cj=$cj+1;
      	$sql5="UPDATE count2 set count1='$cj' where id1='1'";
