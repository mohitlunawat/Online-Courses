...
{
	$q=1;
	$sql="SELECT * FROM question where id1='3'";
	...
	if(isset($_POST['ss']))
	{
		for($t=1;$t<16;$t++)
		{
			if(isset($_POST[$t]))
			{
				...
				$sql2="SELECT * FROM question where id1='3' and qno='$t'";
...
echo "<p><h3 style='text-align:center'>SELECT THE  JAVA QUESTION FOR TEST</h3></p>";
echo "<div style='width:50px; float: left;'>";
echo "<form method='POST' action='qjavaselect.php'>";
	for($i=1;$i<$q;$i++)
	{
