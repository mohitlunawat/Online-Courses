...
{
	$sql="SELECT count FROM subcount2 where in1='8'";
	...
	$top=$_POST['top'];
	$desc=$_POST['desc'];
	$sql2="INSERT INTO try2 VALUES('".$ide."','".$sid."','".$top."','".$desc."')";
	...
	if($result2)
	{
		...
		$sql3="UPDATE subcount2 set count='$cns' where in1='8'";
		$result3=mysqli_query($conn,$sql3);
		echo "<script type='text/javascript'>alert('successfully added');";
	 	echo "window.location='jstring.php'";
     	echo "</script>";
     	$sql4="SELECT count1 from count3 where id1='8'";
		...
		if($result4)
		{
      	...
      	$cj=$cj+1;
      	$sql5="UPDATE count3 set count1='$cj' where id1='8'";
...
<body>
<form method="POST" action="addd8.php">
