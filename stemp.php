...
<span class="tile">Start Thinking!Start Coding</span>
  ...
  <div class="container-fluid">
    <ul class="nav navbar-nav">
      <li class="menu"><a href="time.php"><m>TAKE_TEST</m></a></li>
      <li class="menu"><a href="squery.php"><m>ASK DOUBT</m></a></li>
       <li class="menu"><a href="reply.php"><m>REPLIES</m></a></li>
      <li class="menu"><a href="certify.php"><m>APPLY FOR CERTIFICATE</m></a></li>
      <li class="rig"><a href="#"><n>Welcome: <?php echo strtoupper($name) ?><n></a></li>
