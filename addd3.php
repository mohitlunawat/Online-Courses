...
{
	$sql="SELECT count FROM subcount2 where in1='3'";
	...
	if($result2)
	{
		...
		$sql3="UPDATE subcount2 set count='$cns' where in1='3'";
		...
		if($result4)
		{
      	...
      	$cj=$cj+1;
      	$sql5="UPDATE count3 set count1='$cj' where id1='3'";
...
<body>
<form method="POST" action="addd3.php">
