...
{
	$sql="SELECT count FROM subcount where in1='8'";
	...
	if($result2)
	{
		...
		$sql3="UPDATE subcount set count='$cns' where in1='8'";
		$result3=mysqli_query($conn,$sql3);
		echo "<script type='text/javascript'>alert('successfully added');";
	 	echo "window.location='htables.php'";
     	echo "</script>";
     	$sql4="SELECT count1 from count1 where id1='8'";
		...
		if($result4)
		{
      	...
      	$cj=$cj+1;
      	$sql5="UPDATE count1 set count1='$cj' where id1='8'";
...
<body>
<form method="POST" action="add7.php">
